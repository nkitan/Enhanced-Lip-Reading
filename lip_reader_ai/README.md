...
```Shell
CUDA_VISIBLE_DEVICES=0 python model_trainer.py --config-path <MODEL-JSON-PATH> \
...
```Shell
CUDA_VISIBLE_DEVICES=0 python model_trainer.py --modality raw_audio \
...
```Shell
CUDA_VISIBLE_DEVICES=0 python model_trainer.py --extract-feats \
                                      --config-path <MODEL-JSON-PATH> \
                                      --model-path <MODEL-PATH> \
